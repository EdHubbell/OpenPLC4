...
void glueVars()
{
    ...
    bool_output_ptr[1][0] = (IEC_BOOL *)__QX1_0;
    
    bool_output_ptr[1][1] = (IEC_BOOL *)__QX1_1;
    
    bool_output_ptr[1][2] = (IEC_BOOL *)__QX1_2;
    
    bool_output_ptr[1][3] = (IEC_BOOL *)__QX1_3;
    
    bool_output_ptr[1][4] = (IEC_BOOL *)__QX1_4;
    
    bool_output_ptr[1][5] = (IEC_BOOL *)__QX1_5;
    
    bool_output_ptr[1][6] = (IEC_BOOL *)__QX1_6;
    
    bool_output_ptr[1][7] = (IEC_BOOL *)__QX1_7;
    
    bool_input_ptr[1][0] = (IEC_BOOL *)__IX1_0;
    
    bool_input_ptr[1][1] = (IEC_BOOL *)__IX1_1;
    
    bool_input_ptr[1][2] = (IEC_BOOL *)__IX1_2;
    
    bool_input_ptr[1][3] = (IEC_BOOL *)__IX1_3;
    
    bool_input_ptr[1][4] = (IEC_BOOL *)__IX1_4;
    
    bool_input_ptr[1][5] = (IEC_BOOL *)__IX1_5;
    
    bool_input_ptr[1][6] = (IEC_BOOL *)__IX1_6;
    
    bool_input_ptr[1][7] = (IEC_BOOL *)__IX1_7;
    
    bool_input_ptr[2][0] = (IEC_BOOL *)__IX2_0;
    
    bool_input_ptr[2][1] = (IEC_BOOL *)__IX2_1;
    
    bool_input_ptr[2][2] = (IEC_BOOL *)__IX2_2;
    
    bool_input_ptr[2][3] = (IEC_BOOL *)__IX2_3;
    
    bool_input_ptr[2][4] = (IEC_BOOL *)__IX2_4;
    
    bool_input_ptr[2][5] = (IEC_BOOL *)__IX2_5;
    
    bool_input_ptr[2][6] = (IEC_BOOL *)__IX2_6;
    
    bool_input_ptr[2][7] = (IEC_BOOL *)__IX2_7;
    
    bool_input_ptr[3][0] = (IEC_BOOL *)__IX3_0;
    
    bool_input_ptr[3][1] = (IEC_BOOL *)__IX3_1;
    
    bool_input_ptr[3][2] = (IEC_BOOL *)__IX3_2;
    
    bool_input_ptr[3][3] = (IEC_BOOL *)__IX3_3;
    
    bool_input_ptr[3][4] = (IEC_BOOL *)__IX3_4;
    
    bool_input_ptr[3][5] = (IEC_BOOL *)__IX3_5;
    
    bool_input_ptr[3][6] = (IEC_BOOL *)__IX3_6;
    
    bool_input_ptr[3][7] = (IEC_BOOL *)__IX3_7;
